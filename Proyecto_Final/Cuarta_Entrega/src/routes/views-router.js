...
export default class ViewsRouter extends BaseRouter {
    init() {
        ...
        this.get('/registerFail', ['PUBLIC'], privacy('NO_AUTHENTICATED'), views_register_controllers.registerFailed);
        ...
        this.get('/loginFailed', ['PUBLIC'], privacy('NO_AUTHENTICATED'), views_login_controllers.loginFailed);
