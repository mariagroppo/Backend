/* CLASSES ---------------------------------------------------------------------------- */
import CartsFile from '../classes/fs/cartsManager.js';
const cartList = new CartsFile('../Primera_Practica_Integradora/src/data/listCarts.txt')

import CartsMongoDB from "../classes/mongodb/cartsMongoDB.js";
...
/* export const deleteProduct = async (req,res) => {
    try {
        let id = parseInt(req.params.id);
        let cid = req.body.idCart;
        console.log("ID a borrar: " + id);
        console.log("ID CART: " + cid)
    } catch (error) {
